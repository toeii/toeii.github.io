---
layout:     post
title:      Flutter封装dio网络请求
subtitle:    "针对上次的开源项目改良一下"
date:       2019-03-26
author:     Toeii
...
## 前言
本篇是针对Dio的封装，支持Restful Api，用起来更舒服。

[dio项目地址](https://github.com/flutterchina/dio)

## 过程

#### 添加dio依赖
编辑项目根目录/pubspec.yaml，找到dependecies属性，添加dio依赖
...
```java
    ...
    */
    class HttpUtils {
        ...
        /// default options
        static const String API_PREFIX = 'https://toeii.com/api/v1';
